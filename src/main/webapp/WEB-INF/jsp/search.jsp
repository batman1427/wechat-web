...
<div class="title">
    ...
    <input name="search" type="text" value=<%=(String)session.getAttribute("searchkey")%> class="input-box" />
    </form>
</div>
<div id="nav">
     <hr class="hr10">
     <ul>
			...
			<li><a href="Main_recommend?">房产</a></li>
			<li><a href="Main_recommend?">金融</a></li>
			<li><a href="Main_recommend?">文娱</a></li>
			<li><a href="Main_recommend?">汽车</a></li>
			<li><a href="Main_recommend?">旅游</a></li>
	 </ul>
	 <div style="clear: both"></div>
</div>
<div class="content">
    <% 
    ArrayList<article> al=(ArrayList)session.getAttribute("search");
